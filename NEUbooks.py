...
try:
    ...
    b = a.find_element_by_tag_name('center')
    c = b.find_element_by_id('baseinfo')
    d = c.find_element_by_tag_name('tbody')
    e = d.find_elements_by_tag_name('td')
    #x = browser.find_elements_by_tag_name('td')
    #x = browser.find_elements_by_id('bold')
    """
    i = 34
    while i < 38:
